      ...
      <header class="header">
        <div class="header__container u-container u-container--large">
          ...
          <nav class="header__menu">
            <a href="/#/" class="header__link">Купить BIP</a>
            <a href="/#/sell" class="header__link link2 is-active">Продать BIP</a>
          </nav>
...
body {
  margin: 0;
  font-family: Ubuntu, system-ui, -apple-system, Segoe UI, SimSun, PingFang SC,
...
.header__logo-image {
  ...
  font-size: 36px;
  line-height: 1;
  font-family: Ratio, Ubuntu, system-ui, -apple-system, Segoe UI, SimSun,
    PingFang SC, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol;
  font-weight: 900;
  font-style: italic;
}
